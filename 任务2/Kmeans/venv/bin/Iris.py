    ...
    def loop_for_n_times(self,n):
        ...
        for i in range(n):
            ...
            if self.k * abs(self.avgdist(test_mvc) - self.avgdist(self.meanvector)) < 1e-10:
                break #当前后两次循环的均值向量的所有平均距离小于1e-10时退出循环
        return i+1
...
file_name = "/home/ubuntu/PycharmProjects/Kmeans/venv/Data/Wholesale customers data.csv"
test = Kmeans(file_name,k=8)
print("Wholesale customers数据集","迭代次数:",test.loop_for_n_times(n=10000))
test.show_result()